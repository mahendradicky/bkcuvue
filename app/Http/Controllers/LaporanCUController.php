...
class LaporanCuController extends Controller
{
	...
	public function uploadExcelCuAll(Request $request)
	{
		$type = "laporanCuAll";
	...
	public function uploadExcelCu(Request $request)
	{
		$type = "laporanCU";
		dd(request()->file('file'));
		Excel::import(new LaporanCuDraftImport, request()->file('file'), null, null, $type);
