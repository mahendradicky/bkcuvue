...
class LaporanTpDraftController extends Controller
{
	...
	public function index()
	{
		...
		$table_data = LaporanTpDraft::with('Cu', 'Tp')->where('id_user', $id)->addSelect(['*', DB::raw('
			...
			(IFNULL(laporan_tp_draft.piutang_beredar,0) - (IFNULL(laporan_tp_draft.piutang_lalai_1bulan,0) + IFNULL(laporan_tp_draft.piutang_lalai_12bulan,0))) as piutang_bersih')])->get();
