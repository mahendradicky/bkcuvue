export default {
  ...
  index: function (p) {
    return axios.get('/api/laporanCu', {
      params: p
    });
  },
  ...
  indexGerakan: function (p) {
    return axios.get('/api/laporanCu/indexGerakan', {
      params: p
    });
  },

  indexCu: function (p, id) {
    return axios.get('/api/laporanCu/indexCu/' + id, {
      params: p
    });
  },
  ...
  indexPeriode: function (p, periode) {
    return axios.get('/api/laporanCu/indexPeriode/' + periode, {
      params: p
    });
  },
  ...
  indexPearls: function (p) {
    return axios.get('/api/laporanCu/indexPearls', {
      params: p
    });
  },

  indexPearlsCu: function (p, id) {
    return axios.get('/api/laporanCu/indexPearlsCu/' + id, {
      params: p
    });
  },

  indexPearlsPeriode: function (p, periode) {
    return axios.get('/api/laporanCu/indexPearlsPeriode/' + periode, {
      params: p
    });
  },
