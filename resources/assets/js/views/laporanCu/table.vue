  ...
  data() {
    return {
      ...
      excelUploads: [
        {
          enabled: true,
          url: "laporanCu/uploadExcelCuAll",
        ...
        {
          enabled: true,
          url: "laporanCu/uploadExcelTpAll",
  ...
  methods: {
    ...
    checkProfile() {
      if (this.currentUser.id_cu != 0) {
        ...
        this.excelUploads[0].url = "laporanCu/uploadExcelCu";
        this.excelUploads[0].format_url = "formatLaporanCu.xlsx";
        this.excelUploads[1].url = "laporanTp/uploadExcelTp";
        this.excelUploads[1].format_url = "formatLaporanTp.xlsx";
      } else {
        this.excelUploads[0].url = "laporanCu/uploadExcelCuAll";
        this.excelUploads[0].format_url = "formatLaporanCuSemua.xlsx";
        this.excelUploads[1].url = "laporanTp/uploadExcelTpAll";
